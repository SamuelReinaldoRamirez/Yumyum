...
class Restaurant {
  ...
  factory Restaurant.fromJson(Map<String, dynamic> json) {
    ...
    if (json.containsKey('video_links') &&
        json['video_links'] != null &&
        json['video_links'] != []) {
    ...
    double longitude = json['GPS_address']['data']['lng'] != null
        ? json['GPS_address']['data']['lng'].toDouble()
        : 0.0;
    double latitude = json['GPS_address']['data']['lat'] != null
