                        ...
                        Row(
                          children: [
                            const Icon(Icons.calendar_today,
                                size: 30,
                                color:
                                    AppColors.textColor), // Icône de calendrier
                            const SizedBox(
                                width:
                                    8), // Espacement entre l'icône et la date
                            Text(
                      ...
                      Theme(
                        data: Theme.of(context).copyWith(
                          colorScheme: ColorScheme.light(
                            primary:
                                AppColors.primaryColor, // Couleur principale
                            onPrimary: Colors
                                .white, // Couleur du texte/élément sur la couleur primaire
                            onSurface: AppColors
                                .textColor, // Couleur du texte des jours
                          ),
                          textButtonTheme: TextButtonThemeData(
                            style: TextButton.styleFrom(
                              foregroundColor:
                                  AppColors.primaryColor, // Couleur des boutons
                            ),
                          ),
                        ),
